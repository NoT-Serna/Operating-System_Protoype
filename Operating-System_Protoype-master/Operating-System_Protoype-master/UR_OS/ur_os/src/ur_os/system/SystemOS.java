...
import ur_os.memory.PMM_Segmentation;
...
public class SystemOS implements Runnable{
    ...
    public static ProcessMemoryManagerType PMM = ProcessMemoryManagerType.SEGMENTATION;
    ...
    public void initSimulationQueueSimpler(){
        ...
        }else if(PMM == ProcessMemoryManagerType.CONTIGUOUS){
